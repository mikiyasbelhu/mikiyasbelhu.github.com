...
public class QuizServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        RequestDispatcher rDispatcher = request.getRequestDispatcher("quiz.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        if (start != null) {
            ...
            if (quiz.getNumCorrect() == quiz.getNumQuestions()) {
                quiz = new Quiz();
                session.setAttribute("quiz", quiz);
                RequestDispatcher rDispatcher = request.getRequestDispatcher("quizover.jsp");
                rDispatcher.forward(request, response);
            } else {
                request.setAttribute("error", error);
                request.setAttribute("answer", request.getParameter("txtAnswer"));
                RequestDispatcher rDispatcher = request.getRequestDispatcher("quiz.jsp");
                rDispatcher.forward(request, response);
            }
        }
